// ======================================================================
// Proj_6.v generated from TopDesign.cysch
// 12/03/2025 at 03:40
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50\Bus_Connect_v2_50.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50\Bus_Connect_v2_50.v"
`endif
...
module Scan_ADC_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("b7dca17d-bc29-49ce-bdf3-ccd1033214ba/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module SCB_UART_PDL_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("93b9b41d-65c1-4877-adfe-23a4f207e4a8/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("93b9b41d-65c1-4877-adfe-23a4f207e4a8/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
...
module top ;
	...
	wire [0:0] tmpFB_0__Pin_SW_2_net;
	wire [0:0] tmpIO_0__Pin_SW_2_net;
	electrical [0:0] tmpSIOVREF__Pin_SW_2_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_SW_2
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SW_2_net[0:0]}),
		  .io({tmpIO_0__Pin_SW_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SW_2_net),
		  .annotation({Net_180}));
	...
	cy_mxs40_gpio_v1_0
		#(.id("e4750147-3936-40de-86eb-4963a51a6a6b"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
