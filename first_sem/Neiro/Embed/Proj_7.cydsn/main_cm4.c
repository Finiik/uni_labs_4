...
/*
 * За замовчуванням в прикладі програми використовуються виклики функцій API
 * компонент. Також, встановивши макрос PDL_CONFIGURATION в значення 1, можна
 * використати низькорівненві виклики функції PDL CTDAC.
 */
...
/* Таблиця значень синусоїди в беззнаковому форматі. */
...
/*
 * У головній функції main виконуються наступні дії:
...
int main(void)
{
    ...
    /* Налаштування VDAC з джерелом опорної напруги VDDA
     * та небуферезованим виходом.
     * FastInit налаштує VDAC для беззнакового режиму
     * і буферизованих оновлень з тактовою частотою 500 кГц за замовчуванням.
     */
    Cy_CTDAC_FastInit(CTDAC0, &Cy_CTDAC_Fast_VddaRef_UnbufferedOut);

    /* Налаштування Trigger Mux для маршрутизації вихідного тригера VDAC
     * з вхідним тригером DMA.
     */
    (void)Cy_TrigMux_Connect(
        TRIG14_IN_PASS_TR_CTDAC_EMPTY,
        TRIG14_OUT_TR_GROUP0_INPUT50,
        CY_TR_MUX_TR_INV_DISABLE,
        TRIGGER_TYPE_PASS_TR_CTDAC_EMPTY
    );

    (void)Cy_TrigMux_Connect(
        TRIG1_IN_TR_GROUP14_OUTPUT7,
        TRIG1_OUT_CPUSS_DW1_TR_IN0,
        CY_TR_MUX_TR_INV_DISABLE,
        TRIGGER_TYPE_TR_GROUP_OUTPUT__LEVEL
    );

    /* Дозвіл апаратного блоку CTDAC */
